...
import com.example.addon.LUtils;
...
public class HudExample extends HudElement {
     ...
     */
    public static final HudElementInfo<HudExample> INFO = new HudElementInfo<>(LUtils.HUD_GROUP, "example", "HUD element example.", HudExample::new);
